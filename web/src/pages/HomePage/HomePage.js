      ...
      <AnimatedPage>
        <Grid container component="main" sx={{ height: '100vh' }}>
          ...
          <Grid
            ...
            sx={{
              background: (t) =>
                `url(https://media.discordapp.net/attachments/1100748788861243453/1110271883955413142/v916-nunny-126.jpg) ${t.palette.mode === 'light' ? '#635985' : '#635985'}`,
              backgroundBlendMode: 'overlay',
              backgroundSize: 'cover',
              backgroundPosition: 'center',
              opacity: 0.7, // Altere o valor para ajustar a opacidade
            }}
          />
